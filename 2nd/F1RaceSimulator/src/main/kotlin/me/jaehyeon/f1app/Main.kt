...
import me.jaehyeon.f1app.participants.Race
...
fun main() {
    ...
    val numLaps = promptInt(prompt = "Enter number of laps (up to $MAX_LAPS): ", max = MAX_LAPS)
    val numTeams = promptInt(prompt = "Enter number of teams (up to $MAX_LAPS): ", max = MAX_TEAMS)
    val teams =
        List(numTeams) {
